...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * position callback is called. This values is invalidated whenever a child is attached or
     * detached.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    ...
    void checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        // direction is allowed. This why here, we use mDx mDy to check slope values again.
        final float absDx = Math.abs(dx);
        final float absDy = Math.abs(dy);
    ...
    public interface ViewDropHandler {
         ...
         * @param x      The <code>left</code> offset of the View that is being dragged. This values
         *               includes the movement caused by the user.
         * @param y      The <code>top</code> offset of the View that is being dragged. This values
         *               includes the movement caused by the user.
         */
    ...
    public abstract static class Callback {
         ...
         * account.
         *
         * @param flags           The flag values that include any number of movement flags.
         ...
         * long pressed.
         * <p>
         * Default values returns true but you may want to disable this if you want to start
         ...
         * false otherwise. Default values is <code>true</code>.
         ...
         * over the View, false otherwise. Default values is <code>true</code>.
         ...
         * <p>
         * Default values is .5f, which means, to swipe a View, user must move the View at least
         * half of RecyclerView's width or height, depending on the swipe direction.
         *
         * @param viewHolder The ViewHolder that is being dragged.
         * @return A float values that denotes the fraction of the View size. Default values
         * is .5f .
         */
        @SuppressWarnings("WeakerAccess")
         ...
         *
         * @param viewHolder The ViewHolder that is being dragged.
         * @return A float values that denotes the fraction of the View size. Default values is
         * .5f .
         */
        @SuppressWarnings("WeakerAccess")
         ...
         * <p>
         * You can increase this values to make it harder to swipe or decrease it to make it easier.
         ...
         * <p>
         * The default framework values is passed as a parameter so that you can modify it with a
         * multiplier.
         *
         * @param defaultValue The default values (in pixels per second) used by the
         *                     ItemTouchHelper.
         ...
         * The velocity is calculated in pixels per second.
         * <p>
         * You can customize this behavior by changing this method. If you increase the values, it
         * will be easier for the user to swipe diagonally and if you decrease the values, user will
         * need to make a rather straight finger movement to trigger a swipe.
         *
         * @param defaultValue The default values(in pixels per second) used by the ItemTouchHelper.
         ...
         * <code>view.getTop()</code> of the two views before and after drag started. If that values
         ...
         *                    candidate as a drop.
         * @param curX        The updated left values of the dragged View after drag translations
         *                    are applied. This values does not include margins added by
         *                    {@link RecyclerView.ItemDecoration}s.
         * @param curY        The updated top values of the dragged View after drag translations
         *                    are applied. This values does not include margins added by
         *                    {@link RecyclerView.ItemDecoration}s.
         ...
         * @param x            The updated left values of the dragged View after drag translations
         *                     are applied. This values does not include margins added by
         *                     {@link RecyclerView.ItemDecoration}s.
         * @param y            The updated top values of the dragged View after drag translations
         *                     are applied. This values does not include margins added by
         *                     {@link RecyclerView.ItemDecoration}s.
         */
         ...
         * and after, it changes View's elevation values to be greater than all other children.)
         *
         ...
         * to this action. Default implementation calculates a values based on the amount of View
         ...
         *                            item decorations.
         * @param viewSizeOutOfBounds The total size of the View that is out of bounds. This values
         ...
         * @return The amount that RecyclerView should scroll. Keep in mind that this values will
