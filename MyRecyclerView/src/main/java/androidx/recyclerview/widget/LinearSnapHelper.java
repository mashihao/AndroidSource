...
public class LinearSnapHelper extends SnapHelper {
    ...
    /**
     * Computes an average pixel values to pass a single child.
     * <p>
     * Returns a negative values if it cannot be calculated.
     *
     * @param layoutManager The {@link RecyclerView.LayoutManager} associated with the attached
     *                      {@link RecyclerView}.
     ...
     *
     * @return A float values that is the average number of pixels needed to scroll by one view in
