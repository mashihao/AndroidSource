...
public final class ConcatAdapter extends Adapter<ViewHolder> {
     ...
     * Calling this method is an error and will result in an {@link UnsupportedOperationException}.
     *
     * ConcatAdapter infers this values from added {@link Adapter}s.
     *
    ...
    public void setStateRestorationPolicy(@NonNull StateRestorationPolicy strategy) {
        ...
        throw new UnsupportedOperationException(
                "Calling setStateRestorationPolicy is not allowed on the ConcatAdapter."
                        + " This values is inferred from added adapters");
    }
    ...
    public static final class Config {
         ...
         * id before reporting back to the {@link RecyclerView}. In this mode, the values returned
         * from {@link ViewHolder#getItemId()} might differ from the values returned from
         ...
         *
         * Default values is {@link StableIdMode#NO_STABLE_IDS}.
         */
        @NonNull
        ...
        public enum StableIdMode {
             ...
             * mode, the values returned from {@link ViewHolder#getItemId()} might differ from the
             * values returned from {@link Adapter#getItemId(int)}.
             *
        ...
        public static final class Builder {
             ...
             *                         {@link Config#isolateViewTypes} values ({@code true}).
             * @return this
             ...
             *                     {@link Config#DEFAULT}'s {@link Config#stableIdMode} values
             *                     ({@link StableIdMode#NO_STABLE_IDS}).
             * @return this
