...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements
    ...
    /**
     * Aggregated reverse layout values that takes RTL into account.
     */
    ...
    /**
     * Used to keep the offset values when {@link #scrollToPositionWithOffset(int, int)} is
     * called.
     */
     ...
     * <p>
     * Not that this values is not affected by RecyclerView's layout direction.
     *
     ...
     * <p>
     * Note that, this values is not affected by layout orientation or item order traversal.
    ...
    class Span {
        ...
        // Use this one when default values does not make sense and not having a values means a bug.
        int getStartLine() {
            if (mCachedStart != INVALID_LINE) {
                return mCachedStart;
            }
