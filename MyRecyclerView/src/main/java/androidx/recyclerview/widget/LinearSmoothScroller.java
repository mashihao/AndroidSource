...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
     ...
     *
     * <p>By default, LinearSmoothScroller assumes this method always returns the same values and
     * caches the result of calling it.
     *
     * @param displayMetrics DisplayMetrics to be used for real dimension calculations
     * @return The time (in ms) it should take for each pixel. For instance, if returned values is
